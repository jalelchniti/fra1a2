      ...
      >
        <div className="h-full flex flex-col">
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">{fr.learn}</p>
            ...
            <div className="pt-4 mt-4 border-t border-gray-200">
              <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">{fr.practice}</p>
              ...
              <Link to="/quiz/a1-vocab-flashcards-01" onClick={closeSidebar} className="block px-3 py-2 rounded-md hover:bg-gray-100 text-gray-800">
                {fr.a1_greetings_numbers_flashcards}
              </Link>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div className="text-sm">
                <a href="#" className="text-primary-600 hover:text-primary-800 font-medium">{fr.need_help}</a>
              </div>
            </div>
          </div>
        </div>
