...
const Gr_03_01 = () => {
  ...
  const questions: Question[] = [
    ...
    {
      id: 4,
      question: 'Make the negative: "He is traveling by taxi." → "He ____ traveling by taxi."',
    ...
    {
      id: 5,
      question: 'Make the negative: "They are riding bicycles." → "They ____ riding bicycles."',
    ...
    {
      id: 6,
      question: 'Ask a yes/no question: "You are waiting for the bus." → "____ you waiting?"',
    ...
    {
      id: 7,
      question: 'Ask a yes/no question: "She is driving." → "____ she driving?"',
