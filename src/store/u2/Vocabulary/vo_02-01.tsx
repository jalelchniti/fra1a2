      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-center mb-8">
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
            className="w-full max-w-md aspect-video bg-gradient-to-br from-orange-400 to-orange-600 rounded-xl shadow-lg cursor-pointer flex items-center justify-center text-white text-center p-8"
          >
            <motion.div
...
export default ShoppingVocabularyQuiz;
